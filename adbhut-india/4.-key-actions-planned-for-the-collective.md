...
We will create a use-case library. To share details on successful use-cases widely and openly, to further innovation, replication, or scaling up. Knowing what use-cases can thrive in India/examples of functioning models from India will be helpful in focusing limited resources for maximum leverage. Success here will bring in more resources to the problem.&#x20;
...
3. **Discussions with Policymakers.** These learnings would be openly shared with the relevant policy makers of the country. Explore avenues of creating counter forces beyond regulation.
